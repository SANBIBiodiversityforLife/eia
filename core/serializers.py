...
class FocalSiteJSONSerializer(CustomGeoJSONSerializer):
    def __init__(self, *args, **kwargs):
        self._project_pk = kwargs.pop('project_pk')
        super(FocalSiteJSONSerializer, self).__init__(*args, **kwargs)
    ...
    def end_object(self, obj):
        ...
        additions = {'pk': smart_text(obj.pk, strings_only=True),
                     ...
                     'data_view_url': reverse('focal_site_data', kwargs={'pk': self._project_pk,
                                                                         'focal_site_pk': obj.pk}),
                     'data_upload_url': reverse('focal_site_data_create', kwargs={'project_pk': self._project_pk,
                                                                                  'focal_site_pk': obj.pk}),

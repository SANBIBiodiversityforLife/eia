# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-04-22 07:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter name of equipment make. For solar panels add "PV" or "HCPV" to the make.', max_length=50, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='FatalityData',
            fields=[
                ...
                ('cause_of_death', models.CharField(choices=[('TT', 'Turbine tower'), ('TB', 'Turbine blade'), ('RO', 'Road'), ('SF', 'Solar flux'), ('PV', 'Solar PV panel collision'), ('HE', 'Solar heliostat collision'), ('SB', 'Solar beam collision'), ('PE', 'Power line electrocution'), ('PC', 'Power line collision'), ('NA', 'Natural'), ('PR', 'Predation'), ('UN', 'Undetermined')], help_text='Specify cause of death', max_length=2)),
            ],
        ),
        migrations.CreateModel(
            name='FatalityRate',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity', models.CharField(choices=[('R', 'Roost'), ('C', 'Display/courtship area'), ('F', 'Feeding ground'), ('O', 'Other'), ('N', 'Not specified')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('life_stage', models.CharField(blank=True, choices=[('C', 'Chick/pup'), ('J', 'Juvenile'), ('A', 'Adult'), ('U', 'Unknown')], default='A', help_text='Life<br>stage', max_length=1, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operational_date', models.DateField(blank=True, help_text='E.g. The day on which the turbines first began revolving', null=True)),
                ('construction_date', models.DateField(blank=True, help_text='The date construction began on the project', null=True)),
                ...
                ('equipment_height', django.contrib.postgres.fields.ranges.IntegerRangeField(blank=True, help_text='The collision risk range. Drag slider handlers to move range', null=True)),
        ...
        migrations.CreateModel(
            name='PopulationMetaData',
            fields=[
                ('metadata', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='core.MetaData')),
                ...
                ('survey_types', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('W', 'Walked transect'), ('D', 'Driven transect'), ('P', 'Static point'), ('C', 'Census'), ('I', 'Incidental'), ('R', 'Radar')], default='C', max_length=1), blank=True, null=True, size=None)),
            ],
        ),
        migrations.AddField(
            model_name='removalflag',
            name='metadata',
            field=models.ForeignKey(help_text='The dataset issued for removal', on_delete=django.db.models.deletion.CASCADE, to='core.MetaData'),
        ),
        migrations.AddField(
            model_name='removalflag',
            name='requested_by',
            field=models.ForeignKey(help_text='The user who has requested the removal of this dataset', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
